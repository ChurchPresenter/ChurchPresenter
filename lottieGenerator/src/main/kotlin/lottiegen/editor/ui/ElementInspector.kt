...
import lottiegen.spec.AnchorIn
import lottiegen.spec.AnimProperty
import lottiegen.spec.AnimTrack
import lottiegen.spec.BackgroundElement
import lottiegen.spec.ColorRole
import lottiegen.spec.CornerSpec
import lottiegen.spec.EasingKind
import lottiegen.spec.ElementSpec
import lottiegen.spec.EllipseElement
import lottiegen.spec.FillSpec
import lottiegen.spec.GradientSpec
import lottiegen.spec.GrowOrigin
import lottiegen.spec.ImageElement
import lottiegen.spec.ImageScaleMode
import lottiegen.spec.LineAnchor
import lottiegen.spec.LogoElement
import lottiegen.spec.CurveVertex
import lottiegen.spec.MaskRevealSpec
import lottiegen.spec.MirrorMode
import lottiegen.spec.OffsetUnit
import lottiegen.spec.PaintSpec
import lottiegen.spec.PathElement
import lottiegen.spec.Placement
import lottiegen.spec.PlacementOverride
import lottiegen.spec.PolygonElement
import lottiegen.spec.RepeatSpec
import lottiegen.spec.RectElement
import lottiegen.spec.SizeSpec
import lottiegen.spec.SpecKeyframe
import lottiegen.spec.SpecLayoutContext
import lottiegen.spec.StrokeSpec
import lottiegen.spec.StrokeWidthSpec
import lottiegen.spec.TextAnimatorKind
import lottiegen.spec.TextAnimatorSpec
import lottiegen.spec.TextElement
import lottiegen.spec.TextFieldRef
import lottiegen.spec.VisibilityRule
import lottiegen.spec.WidthBasis
