...
MODULE_DIRS="converter|companion-satellite|theme|core-models|bible-engine|lottieGenerator|crossword|presentation-engine|settings|diagnostics|atem|planning-center|bible-formats|songlibrary|song-chords|bible|dictionary|dictionary-tab|dictionary-settings-tab|companion-server|statistics|ui-components"
