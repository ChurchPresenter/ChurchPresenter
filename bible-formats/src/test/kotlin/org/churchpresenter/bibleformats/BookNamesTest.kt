...
class BookNamesTest {
    ...
    private val allTables: Map<String, Map<Int, String>> = mapOf(
        ...
        "CZECH" to BookNames.CZECH,
        "SLOVAK" to BookNames.SLOVAK,
        "CROATIAN" to BookNames.CROATIAN,
        "ROMANIAN" to BookNames.ROMANIAN,
        "SWEDISH" to BookNames.SWEDISH,
        "NORWEGIAN" to BookNames.NORWEGIAN,
        "FINNISH" to BookNames.FINNISH,
        "ESTONIAN" to BookNames.ESTONIAN,
        "LATVIAN" to BookNames.LATVIAN,
        "BELARUSIAN" to BookNames.BELARUSIAN,
        "KAZAKH" to BookNames.KAZAKH,
        "UZBEK" to BookNames.UZBEK,
        "TURKISH" to BookNames.TURKISH,
        "PERSIAN" to BookNames.PERSIAN,
        "HINDI" to BookNames.HINDI,
        "NEPALI" to BookNames.NEPALI,
        "THAI" to BookNames.THAI,
        "LAO" to BookNames.LAO,
        "JAPANESE" to BookNames.JAPANESE,
        "INDONESIAN" to BookNames.INDONESIAN,
        "MALAY" to BookNames.MALAY,
        "TAGALOG" to BookNames.TAGALOG,
        "SWAHILI" to BookNames.SWAHILI,
        "TAMIL" to BookNames.TAMIL,
    )
