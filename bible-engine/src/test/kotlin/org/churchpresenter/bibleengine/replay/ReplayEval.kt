package org.churchpresenter.bibleengine.replay

import org.churchpresenter.bibleengine.AppConfig
import java.io.File
...
object ReplayEval {
    ...
    private fun sameVerse(t: GroundTruth, e: ScriptureEvent): Boolean {
        if (t.canonical) {
