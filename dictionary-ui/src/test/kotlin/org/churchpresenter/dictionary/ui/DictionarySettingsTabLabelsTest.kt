...
class DictionarySettingsTabLabelsTest {
    ...
    @Test
    fun `every label the tab renders is on screen the expected number of times`() = dictionarySettingsTab { _ ->
    ...
    @Test
    fun `the tab renders no text beyond the inventory`() = dictionarySettingsTab { _ ->
