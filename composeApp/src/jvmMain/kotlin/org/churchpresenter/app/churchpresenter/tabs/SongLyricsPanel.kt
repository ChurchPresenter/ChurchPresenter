...
private fun LyricSectionEntry(
    ...
    Column(
        ...
        // The panel always shows every language the song carries — what an output shows is that
        // output's business, and the operator needs to see all of it to know what is going where.
