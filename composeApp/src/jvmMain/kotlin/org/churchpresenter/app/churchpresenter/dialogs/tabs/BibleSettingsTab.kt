                        ...
                        TextButton(
                            ...
                            onClick = {
                                ...
                                val baseStyle = TextStyle(
                                    ...
                                    textDecoration = if (bs.primaryBibleUnderline) TextDecoration.Underline
                    ...
                    if (presenterManager != null) {
                        TextButton(
                            ...
                            onClick = {
                                ...
                                val refText = "${verse.bookName} ${verse.chapter}:${verse.verseNumber}"
                                val ltRefH = textMeasurer.measure(
                                    refText,
                                    refStyle.copy(fontSize = bs.primaryReferenceLowerThirdFontSize.sp),
                                    density = Density(1f)
                                ).size.height
                                val ltSize = calculateAutoFitFontSize(
                                    textMeasurer,
                                    text,
                                    baseStyle,
                                    availW,
        ...
        Column(verticalArrangement = Arrangement.spacedBy(4.dp)) {
            ...
            Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                ...
                HorizontalAlignmentButtons(
                    ...
                    onAlignmentChange = { value ->
                        update { t -> t.copy(lowerThirdReferenceHorizontalAlignment = value) }
                    },
                    leftValue = Constants.LEFT, centerValue = Constants.CENTER, rightValue = Constants.RIGHT
                )
            }
