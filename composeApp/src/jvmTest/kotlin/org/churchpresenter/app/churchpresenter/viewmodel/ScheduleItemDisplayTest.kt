...
class ScheduleItemDisplayTest {
    ...
    fun `every schedule item type has its own glyph`() {
        val cases = listOf(
            ...
            ScheduleItem.PresentationItem(id = "5",
                filePath = "/d.pptx",
                fileName = "d",
                slideCount = 1,
                fileType = "pptx") to "📊",
            ScheduleItem.MediaItem(id = "6", mediaUrl = "/m.mp4", mediaTitle = "m", mediaType = "local") to "🎬",
            ScheduleItem.LowerThirdItem(id = "7",
                presetId = "p",
                presetLabel = "p",
                pauseAtFrame = false,
                pauseDurationMs = 0L) to "▼",
            ...
            ScheduleItem.DictionaryItem(id = "11",
                number = "1",
                word = "w",
                transliteration = "t",
                definition = "d") to "📖",
    ...
    fun `every schedule item type resolves to its declared palette slot`() {
        val cases = listOf(
            ...
            ScheduleItem.BibleVerseItem(id = "2",
                ...
                verseNumber = 16,
                verseText = "x") to 1,
            ScheduleItem.PresentationItem(id = "3",
                filePath = "/d.pptx",
                fileName = "d",
                slideCount = 1,
                fileType = "pptx") to 2,
            ...
            ScheduleItem.DictionaryItem(id = "10",
                number = "1",
                word = "w",
                transliteration = "t",
                definition = "d") to 1,
    ...
    fun `every schedule item type maps to its own tab's string resource`() {
        val cases = listOf(
            ...
            ScheduleItem.BibleVerseItem(id = "2",
                ...
                chapter = 3,
                verseNumber = 16,
                verseText = "x") to Res.string.bible,
            ScheduleItem.PresentationItem(id = "3",
                filePath = "/d.pptx",
                fileName = "d",
                slideCount = 1,
                fileType = "pptx") to Res.string.presentation,
            ScheduleItem.PictureItem(id = "4",
                folderPath = "/p",
                folderName = "p",
                imageCount = 1) to Res.string.pictures,
            ScheduleItem.MediaItem(id = "5",
                mediaUrl = "/m.mp4",
                mediaTitle = "m",
                mediaType = "local") to Res.string.media_tab_title,
            ScheduleItem.LowerThirdItem(id = "6",
                presetId = "p",
                presetLabel = "p",
                pauseAtFrame = false,
                pauseDurationMs = 0L) to Res.string.schedule_kind_lower_third,
            ...
            ScheduleItem.DictionaryItem(id = "10",
                ...
                word = "w",
                transliteration = "t",
                definition = "d") to Res.string.tab_dictionary,
        )
    ...
    @Test fun `a short bible verse shows in full`() =
        assertEquals("For God so loved", scheduleItemDetailText(
            ScheduleItem.BibleVerseItem(id = "1",
                bookName = "John",
                chapter = 3,
                verseNumber = 16,
    ...
    @Test fun `a presentation detail is its uppercased type and path`() =
        assertEquals("PPTX - /decks/a.pptx", scheduleItemDetailText(
            ScheduleItem.PresentationItem(id = "1",
