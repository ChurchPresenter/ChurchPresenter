...
class WebTabEngineUnavailableTest {
    ...
    @Test
    fun `WebTab with no engine shows the generic unavailable message`() = webTab(cefInitialized = false,
        cefMacOsUnsupported = false) { _,
        _ ->
    ...
    @Test
    fun `WebTab on an unsupported macOS shows the macOS-specific message`() = webTab(cefInitialized = false,
        cefMacOsUnsupported = true) { _,
        _ ->
