...
/**
 * Every control on screen with no accessible name at all: no text, no description, no role.
 *
 ...
 */
fun ComposeUiTest.unlabelledControls(): SemanticsNodeInteractionCollection =
    onAllNodes(
        hasClickAction() and
 ...
 */
fun mixedCaseInstalledFont(): String =
