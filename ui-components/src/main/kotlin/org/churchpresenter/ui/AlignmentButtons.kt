        ...
        TooltipArea(
            ...
            OutlinedButton(
                ...
                Image(
                    ...
                    contentDescription = null,
                    modifier = Modifier.size(iconSize),
                    colorFilter = ColorFilter.tint(if (selectedAlignment == leftValue) MaterialTheme.colorScheme.primary
                    else MaterialTheme.colorScheme.onSurface),
                )
            }
        }
        ...
        TooltipArea(
            ...
            OutlinedButton(
                ...
                Image(
                    ...
                    modifier = Modifier.size(iconSize),
                    colorFilter = ColorFilter.tint(if (selectedAlignment == topValue) MaterialTheme.colorScheme.primary
                    else MaterialTheme.colorScheme.onSurface),
                )
            }
        }
    ...
    Row {
        OutlinedButton(
            ...
            Image(
                ...
                modifier = Modifier.size(iconSize),
                colorFilter = ColorFilter.tint(if (selectedPosition == aboveValue) MaterialTheme.colorScheme.primary
                else MaterialTheme.colorScheme.onSurface),
            )
        }
        OutlinedButton(
            ...
            Image(
                ...
                modifier = Modifier.size(iconSize),
                colorFilter = ColorFilter.tint(if (selectedPosition == belowValue) MaterialTheme.colorScheme.primary
                else MaterialTheme.colorScheme.onSurface),
            )
        }
    }
