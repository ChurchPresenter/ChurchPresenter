 ...
 */
class ClientLabelEditor(label: String) {
    var editing by mutableStateOf(false)
    var text by mutableStateOf(label)
}

@Composable
fun rememberClientLabelEditor(label: String): ClientLabelEditor =
    remember(label) { ClientLabelEditor(label) }

/** The pencil. Callers place it wherever their own row puts actions. */
@Composable
fun ClientLabelEditButton(state: ClientLabelEditor, label: String) {
    IconButton(
