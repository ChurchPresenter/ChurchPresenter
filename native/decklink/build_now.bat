...
REM === Copy to resource locations ===
set "REPO=%~dp0..\.."
copy /Y decklink_jni.dll "%REPO%\composeApp\src\jvmMain\resources\win-x64\decklink_jni.dll"
copy /Y decklink_jni.dll "%REPO%\composeApp\src\jvmMain\appResources\windows\decklink_jni.dll"
