...
**The suite is clean: `verifyRoborazziJvm` fails 0 of 793 images on `main`** — measured 2026-08-24 on
macOS. Another 61 live in `ui-components/screenshots`, 21 in `dictionary-tab/screenshots` and 49 in
